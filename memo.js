const DEFAULT_HABITS = [
  // Prayer
  { name: "Fajr", cat: "Prayer", icon: "🕌" },
  { name: "Dhuhr", cat: "Prayer", icon: "🕌" },
  { name: "Asr", cat: "Prayer", icon: "🕌" },
  { name: "Maghrib", cat: "Prayer", icon: "🕌" },
  { name: "Isha", cat: "Prayer", icon: "🕌" },
  // Quran
  { name: "Quran memorization", cat: "Quran", icon: "📖" },
